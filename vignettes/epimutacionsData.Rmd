...
The `epimutacionsData` package is a repository of  datasets for the `epimutacions` package. It includes 2 datasets to use as an example: (1) Reference panel and (2) case and control samples. We also included a dataset specifying the candidate regions in  Illumina 450K array to be epimutations. 
